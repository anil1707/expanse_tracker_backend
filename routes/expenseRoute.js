...
const { allTripController, addNewTrip, expense, addExpense, getIndIndividualGroupExpanse } = require("../controller/expenseController");
...
expenseRoute.get("/indivudualGroupExpanse/:id",protect, getIndIndividualGroupExpanse)
